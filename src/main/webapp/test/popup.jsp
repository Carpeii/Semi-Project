				...
				<input type="hidden" name="rentPrice" value="<%=rentPrice%>"/>
					...
					<table class="table custom-table" style="border:none;">
						...
						<div>
					         	...
					         	<span><%=rentPrice%>원</span>
					         	<br/><span>~<%=CheckOut.plusDays(6)%></span>
						</div>
            			</td>
							</c:if>
            			...
            			<div>
								...
								<span><%=rentPrice*2%>원</span>
								<br/><span>~<%=CheckOut.plusDays(13)%></span>
            			</div>
						</td>
							</c:if>
						...
						<div>
								...
								<span><%=rentPrice*3%>원</span>
								<br/><span>~<%=CheckOut.plusDays(20)%></span>
						</div>
						</td>
							</c:if>
						</tr>
						<tr>
							...
							<div>
								...
								<span><%=rentPrice*4%>원</span>
								<br/><span>~<%=CheckOut.plusDays(27)%></span>
							</div>
							</td>
							</c:if>
							...
							<div>
								...
								<span><%=rentPrice*5%>원</span>
								<br/><span>~<%=CheckOut.plusDays(34)%></span>
							</div>
							</td>
							</c:if>
							...
							<div>
								...
								<span><%=rentPrice*6%>원</span>
								<br/><span>~<%=CheckOut.plusDays(41)%></span>
							</div>
							</td>
							</c:if>
						</tr>
						<tr>
							...
							<div>
								...
								<span><%=rentPrice*7%>원</span>
								<br/><span>~<%=CheckOut.plusDays(48)%></span>
							</div>
							</td>
							</c:if>
							...
							<div>
								...
								<span><%=rentPrice*8%>원</span>
								<br/><span>~<%=CheckOut.plusDays(62)%></span>
							</div>
							</td>
							</c:if>
							...
							<div>
								...
								<span><%=rentPrice*9%>원</span>
								<br/><span>~<%=CheckOut.plusDays(69)%></span>
							</div>
							</td>
							</c:if>
						</tr>
						<tr>
							...
							<div>
								...
								<span><%=rentPrice*10%>원</span>
								<br/><span>~<%=CheckOut.plusDays(76)%></span>
							</div>
							</td>
							</c:if>
							...
							<div>
								...
								<span><%=rentPrice*11%>원</span>
								<br/><span>~<%=CheckOut.plusDays(83)%></span>
							</div>
							</td>
							</c:if>
							...
							<div>
								...
								<span><%=rentPrice*12%>원</span>
								<br/><span>~<%=CheckOut.plusDays(90)%></span>
							</div>
							</td>
							</c:if>
						</tr>
