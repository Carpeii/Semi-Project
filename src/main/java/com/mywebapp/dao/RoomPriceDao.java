...
public class RoomPriceDao {
    ...
    public void create(RoomPrice roomPrice) throws SQLException {
        ...
        try {
            ...
            String sql = "INSERT INTO room_price (room_id, rent_price, long_term, long_term_discount, early_check_in, early_check_in_discount, maintenance_bill, maintenance_bill_discount, electricity, water, gas, internet, cleaning_fee, refund_type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
